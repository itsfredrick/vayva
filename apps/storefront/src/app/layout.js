...
export default function RootLayout({ children }) {
    return (_jsxs("html", { lang: "en", suppressHydrationWarning: true, children: [_jsxs("head", { children: [_jsx("link", { rel: "preconnect", href: process.env.NEXT_PUBLIC_API_URL || "" }), _jsx("link", { rel: "preconnect", href: "https://images.unsplash.com" }), _jsx("link", { rel: "dns-prefetch", href: "https://images.unsplash.com" })] }), _jsxs("body", { className: `${spaceGrotesk.variable} ${inter.variable} font-sans antialiased bg-white text-black min-h-screen flex flex-col`, suppressHydrationWarning: true, children: [_jsx(Suspense, { fallback: _jsx("div", { className: "p-10 text-center", children: "Loading..." }), children: _jsx(StoreProvider, { children: children }) }), _jsx(Analytics, {}), _jsx(SpeedInsights, {})] })] }));
}

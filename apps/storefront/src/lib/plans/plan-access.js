 ...
 */
export function canAccessTemplate(userTier, templateTier) {
 ...
 */
export function getLockedReason(userTier, templateTier) {
 ...
 */
export function isTemplateAllowed(userTier, requiredTier) {

import { SITE_ORIGIN, isAllowIndex, isHardNoindex, pageTypeFor, } from "./route-policy";
...
export function metadataFor(path, ctx) {
...
function computeTitle(path, ctx) {
...
function computeDescription(path, ctx) {
    const pt = pageTypeFor(path);
    switch (pt) {
        case "home":
...
export function jsonLdFor(path, ctx) {

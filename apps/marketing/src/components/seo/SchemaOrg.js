...
export function SchemaOrg({ type }) {
    const getSchema = () => {
        switch (type) {
            case "Organization":
                return {
                    ...
                    description: "Nigeria's #1 AI-powered commerce platform. Build, sell, and grow on WhatsApp with automated ordering and payments.",
                    address: {
                        "@type": "PostalAddress",
            ...
            case "SoftwareApplication":
                return {
                    ...
                    description: "AI-powered commerce platform for Nigerian merchants. Automate WhatsApp orders, accept payments, and manage logistics.",

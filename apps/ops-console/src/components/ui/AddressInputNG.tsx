    ...
    <div className="space-y-4">
      <div>
        ...
        <input
          ...
          onChange={(e: any) => handleChange("addressLine1", (e as any).target.value)}
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <select
            value={value?.state || ""}
            onChange={(e: any) => handleChange("state", (e as any).target.value)}
        ...
        <div>
          ...
          <input
            value={value?.city || ""}
            onChange={(e: any) => handleChange("city", (e as any).target.value)}
            className="w-full border p-2 rounded"
      ...
      <div>
        ...
        <input
          ...
          onChange={(e: any) => handleChange("landmark", (e as any).target.value)}
          className="w-full border p-2 rounded"

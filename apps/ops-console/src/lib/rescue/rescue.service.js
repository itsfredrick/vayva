...
export class RescueService {
     ...
     */
    static async intakeIncident(report, actorOpsUserId // If triggered manually by an operator
    ) {
    ...
    static async diagnoseError(report) {
        const systemPrompt = `
...
`;
    ...
    static extractRemediation(diagnosis) {
    ...
    static extractClassification(diagnosis) {
        const lines = diagnosis.split('\n');
    ...
    static extractEscalation(diagnosis) {
        const lines = diagnosis.split('\n');

        ...
        <div className="p-8 space-y-6">
            ...
            <div className="flex border-b border-gray-200">
                <button
                    ...
                    className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors flex items-center gap-2 ${activeTab === "TEMPLATES"
                ...
                <button
                    ...
                    className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors flex items-center gap-2 ${activeTab === "APPS"
                            ? "border-indigo-600 text-indigo-600"
                            : "border-transparent text-gray-500 hover:text-gray-700"
                        }`}
                >

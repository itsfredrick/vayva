...
export class DiscountService {
     ...
     */
    static async createDiscount(storeId, data) {
    ...
    static async getDiscount(storeId, ruleId) {
    ...
    static async updateDiscount(storeId, ruleId, data) {
        return await prisma.$transaction(async (tx) => {
            // 1. Update Rule
    ...
    static async listDiscounts(storeId) {
        // Fetch rules
    ...
    static async deleteDiscount(storeId, ruleId) {
        return await prisma.$transaction(async (tx) => {

...
export class DeletionService {
     ...
     */
    static async confirmDeletion(token) {
     ...
     */
    static async cancelDeletion(storeId, userId) {
     ...
     */
    static async getStatus(storeId) {
     ...
     */
    static async executeDeletion(requestId) {
    ...
    static async checkBlockers(storeId) {
        const blockers = [];

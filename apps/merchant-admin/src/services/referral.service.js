...
export class ReferralService {
     ...
     */
    static async getOrCreateCode(storeId) {
    ...
    static async getStats(storeId) {
        ...
        const referralCode = store?.settings?.referralCode;
     ...
     */
    static async trackReferral(refereeStoreId, referralCode) {
     ...
     */
    static async processRefereePayment(refereeStoreId) {
        ...
        const referrerStoreId = attribution.metadata?.referrerStoreId;
        if (!referrerStoreId)
            return;
    ...
    static async generateCode(storeId) {
        return this.getOrCreateCode(storeId);
    }
    static async getMonthlyDiscount(storeId) {
        // Stub implementation
        return 0;
    }
}

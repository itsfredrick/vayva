...
export class InventoryService {
     ...
     */
    static async getDefaultLocation(storeId) {
     ...
     */
    static async adjustStock(storeId, variantId, productId, quantityChange, reason, actorId, locationId) {
     ...
     */
    static async getHistory(storeId, variantId) {

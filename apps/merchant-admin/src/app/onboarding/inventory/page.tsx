...
import { InventoryProduct } from "@/types/onboarding";
...
export default function InventoryPage() {
    ...
    const handleContinue = async () => {
        const finalProduct: InventoryProduct = {
            name: product.name,
    ...
    const handleBack = async () => {
        // Smart routing: if delivery is disabled, go back to finance, else logistics
        if (state?.intent?.hasDelivery === false) {
        ...
        <div className="max-w-3xl mx-auto py-8">
            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1 space-y-4">
                    <Input
                        label={LABEL_MAP[segment] || LABEL_MAP["default"]}

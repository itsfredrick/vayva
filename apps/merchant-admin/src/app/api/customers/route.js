...
export const GET = withVayvaAPI(PERMISSIONS.CUSTOMERS_VIEW, async (req, { storeId }) => {
    try {
...
export const POST = withVayvaAPI(PERMISSIONS.CUSTOMERS_MANAGE, async (req, { storeId }) => {
    try {

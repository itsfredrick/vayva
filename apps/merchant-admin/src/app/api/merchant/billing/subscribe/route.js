...
export const POST = withVayvaAPI(PERMISSIONS.BILLING_MANAGE, async (request, { storeId, user }) => {
    ...
    try {
        ...
        const payment = await PaystackService.createPaymentForPlanChange(user.email, plan_slug, storeId);

...
export const POST = withVayvaAPI(PERMISSIONS.COMMERCE_MANAGE, async (req, { storeId, user, correlationId }) => {
    try {
...
export const GET = withVayvaAPI(PERMISSIONS.COMMERCE_VIEW, async (req, { storeId }) => {
    try {

...
export const GET = withVayvaAPI(PERMISSIONS.MARKETING_VIEW, async (request, { storeId }) => {
    try {
...
export const POST = withVayvaAPI(PERMISSIONS.MARKETING_MANAGE, async (request, { storeId }) => {
    try {

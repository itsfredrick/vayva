...
export const POST = withVayvaAPI(PERMISSIONS.MARKETING_MANAGE, async (req, { storeId }) => {
    try {
...
export const GET = withVayvaAPI(PERMISSIONS.MARKETING_VIEW, async (req, { storeId }) => {
    try {

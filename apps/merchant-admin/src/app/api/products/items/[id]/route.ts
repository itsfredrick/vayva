...
export const GET = withVayvaAPI(PERMISSIONS.COMMERCE_VIEW, async (request, { storeId, params }) => {
    try {
...
export const PUT = withVayvaAPI(PERMISSIONS.COMMERCE_MANAGE, async (request, { storeId, params }) => {
    try {
        const { id } = await params;
...
export const DELETE = withVayvaAPI(PERMISSIONS.COMMERCE_MANAGE, async (request, { storeId, params }) => {
    try {
        const { id } = await params;

...
export default async function CustomersPage() {
    ...
    const customers = dbCustomers.map(c => {
        ...
        const totalSpend = c.orders.reduce((acc, o) => {
            const val = o.total.toNumber ? o.total.toNumber() : Number(o.total);
            return acc + val;
        }, 0);
        // Determine status
    ...
    return (_jsx("div", { className: "p-6 md:p-8 max-w-7xl mx-auto", children: _jsx(CustomerListContainer, { customers: customers }) }));
}

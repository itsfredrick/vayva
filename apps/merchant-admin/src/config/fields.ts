...
import { FieldKey } from "@/lib/templates/types";

export type FieldType = "text" | "number" | "textarea" | "select" | "multiselect" | "image" | "file" | "date" | "boolean" | "tags";
...
export const FIELD_REGISTRY: Record<FieldKey, FieldDefinition> = {
    // --- CORE IDENTITY ---

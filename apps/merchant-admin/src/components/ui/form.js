...
const FormLabel = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return (_jsx("label", { ref: ref, className: cn("text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70", error && "text-destructive", className), htmlFor: formItemId, ...props }));
});
...
const FormControl = React.forwardRef(({ ...props }, ref) => {
    ...
    return (_jsx("div", { ref: ref, id: formItemId, "aria-describedby": !error
            ? `${formDescriptionId}`
            : `${formDescriptionId} ${formMessageId}`, "aria-invalid": error ? "true" : "false", ...props }));
});

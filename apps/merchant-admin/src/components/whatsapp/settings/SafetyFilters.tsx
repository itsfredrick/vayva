...
export function SafetyFilters(props: SafetyFiltersProps) {
                    ...
                    {formData.rateLimitEnabled && (
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                min="1"
                                max="1000"
                                value={(formData.rateLimitPerHour as any)}
                                onChange={(e: any) =>
                        ...
                        <div className="pt-4 space-y-4 border-t">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    min="0"
                                    max="100"
                                    value={(formData.aiSensitivity as any)}
                ...
                <CardContent className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            value={(formData.blockedNumbers as any)}
                            onChange={(e: any) =>
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea
                            ...
                            value={(formData.blockedKeywords as any)}
                            onChange={(e: any) =>

...
export default function WalletGuard({ children }: WalletGuardProps) {
    ...
    return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 bg-gray-50/50 rounded-2xl border border-gray-100">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 max-w-sm w-full text-center space-y-6">
                <div className="w-16 h-16 bg-blue-50 text-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Lock size={32} />
                </div>

                <div>
                    <h2 className="text-xl font-bold text-gray-900">Wallet Locked</h2>
                    <p className="text-sm text-gray-500 mt-1">Enter your 4-6 digit PIN to access funds.</p>
                </div>

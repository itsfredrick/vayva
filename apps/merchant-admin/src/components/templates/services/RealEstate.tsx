          ...
          <div className="bg-white/10 p-6 backdrop-blur-md rounded-lg max-w-md">
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <select
                  className="w-full bg-transparent border-b border-gray-500 text-white py-1 outline-none text-sm"
            ...
            <Button className="w-full bg-white text-slate-900 py-3 font-bold uppercase tracking-widest text-xs hover:bg-gray-100 h-auto">
              Search Listings
            </Button>
          </div>
        </div>
          ...
          {[
            ...
            >
              ...
              <div className="p-4 flex justify-between items-center">
                ...
                <Button className="bg-slate-900 text-white px-4 py-2 text-xs font-bold rounded uppercase h-auto">
                  Tour
                </Button>
              </div>
            </div>

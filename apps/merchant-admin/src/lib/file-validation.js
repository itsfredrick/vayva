 ...
 * Validate file size
 */
export function validateFileSize(file, maxSizeBytes = DEFAULT_IMAGE_MAX_SIZE) {
 ...
 * Validate MIME type
 */
export function validateMimeType(file, allowedTypes = DEFAULT_ALLOWED_IMAGE_TYPES) {
 ...
 */
export async function checkMaliciousContent(file) {
    try {
 ...
 */
export async function validateUploadedFile(formData, fieldName = 'file', options = {}) {

        ...
        faqs: [
            {
                ...
                answer: 'For most Nigerian merchants, yes. By charging in NGN and having no platform transaction fees, Vayva eliminates the hidden costs of currency conversion and "Shopify Tax".',
            },
            {
            ...
            },
            {
                ...
                answer: "Yes, Vayva is mobile-first, allowing you to manage orders and chat with customers entirely from your phone.",
            },
            {
    ...
    squarespace: {
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: "Yes, Vayva has a dedicated Ticketing template with QR check-in—Squarespace does not.",
            },
            {

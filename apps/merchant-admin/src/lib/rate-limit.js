 ...
 */
export async function checkRateLimit(userId, routeKey, limit, durationSeconds, storeId) {
    ...
    if (record.points > limit) {
        ...
        // We will log it.
        if (storeId) {
            await logAuditEvent(storeId, userId, AuditEventType.SECURITY_RATE_LIMIT_BLOCKED, {

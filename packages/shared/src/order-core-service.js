...
export class OrderCoreService {
     ...
     */
    static async splitOrder(parentOrderId) {
        ...
        }); // Cast to any to avoid TS inference issues with Prisma include in shared package
        if (!order)
 ...
 */
    static async createOrdersFromCart(cartId, userId) {
        ...
        return await prisma.$transaction(async (tx) => {
            ...
            const groupMap = new Map(); // storeId -> fulfillmentGroupId

export function generateDefaultPolicies(input) {
    const { storeName, storeSlug, merchantSupportWhatsApp = "Contact us via WhatsApp", supportEmail = `support@${storeSlug}.com`, pickupAddress = "Lagos, Nigeria", deliveryCities = ["Lagos"], returnsWindowDays = 7, refundWindowDays = 5, dispatchMode = "both", partnerName = "Kwik", } = input;
    return [
...
function generateTermsPolicy(input) {
...
function generateReturnsPolicy(input) {
...
function generateRefundsPolicy(input) {
...
function generateShippingDeliveryPolicy(input) {
    const { storeName, merchantSupportWhatsApp, supportEmail, deliveryCities = ["Lagos"], dispatchMode = "both", partnerName = "Kwik", pickupAddress = "Lagos, Nigeria", } = input;
